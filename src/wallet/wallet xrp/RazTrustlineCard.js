...
const styles = {
  ...
  issuerBox: {
    padding: 10, borderRadius: 12, background: 'rgba(0,0,0,0.03)', marginBottom: 10,
  },
  issuer: {
    fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace',
    wordBreak: 'break-all', opacity: 0.9, fontSize: 12,
  },
  presentBox: { padding: 12, borderRadius: 12, background: 'rgba(0,0,0,0.03)', marginBottom: 8 },
  kv: { display: 'grid', gridTemplateColumns: '120px 1fr', gap: 8, fontSize: 14, margin: '2px 0' },
  primaryBtn: { padding: '10px 14px', borderRadius: 12, border: '1px solid var(--primary-color)', background: 'var(--primary-color)', color: '#fff', cursor: 'pointer', fontWeight: 700 },
  status: { marginTop: 10, fontSize: 13, opacity: 0.75 },
  error: { marginTop: 6, color: '#b3261e', fontSize: 13 },
  payloadBox: { marginTop: 12, padding: 10, background: 'rgba(0,0,0,0.03)', borderRadius: 12 },
  qrWrap: { display: 'grid', placeItems: 'center', minHeight: 200 },
  qrFallback: { width: 180, height: 180, borderRadius: 12, background: 'rgba(0,0,0,0.06)' },
  openLink: { display: 'inline-block', marginTop: 8, fontSize: 14, textDecoration: 'underline', color: 'var(--primary-color)' },
  resultBox: { marginTop: 10, padding: 10, background: 'rgba(0,0,0,0.03)', borderRadius: 12, textAlign: 'left' },
};
